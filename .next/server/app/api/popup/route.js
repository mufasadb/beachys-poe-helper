(()=>{var e={};e.id=446,e.ids=[446],e.modules={399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},9348:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},412:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},615:(e,t,i)=>{"use strict";i.r(t),i.d(t,{patchFetch:()=>g,routeModule:()=>l,serverHooks:()=>v,workAsyncStorage:()=>c,workUnitAsyncStorage:()=>p});var s={};i.r(s),i.d(s,{GET:()=>d});var a=i(2412),o=i(4293),r=i(4147),n=i(7856);async function d(e){let{searchParams:t}=new URL(e.url),i=t.get("module"),s=t.get("category");if(!i){let e=n.NextResponse.json({modules:["cheat-sheets","vendor-search","dashboard","vendor-recipes"],categories:{"cheat-sheets":["leveling","atlas","settlers","sanctum","expedition","heist","betrayal","delve","incursion"],"vendor-search":["movement-boots","generic-searches"],dashboard:["info-wiki","trading-economy","build-planning","crafting-planning","filters-qol","leveling-progression"],"vendor-recipes":["currency","equipment","gems","flasks"]}});return e.headers.set("Cache-Control","public, max-age=3600, s-maxage=3600"),e.headers.set("ETag",'"modules-list-v1"'),e}switch(i){case"cheat-sheets":return function(e){let t={leveling:{id:"leveling",title:"Leveling Guide",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
Act 1 - Key Quests:
...
• Chaos resistance not crucial early`},atlas:{id:"atlas",title:"Atlas Progression",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
Early Atlas (T1-T5):
...
• Legion (emblems and currency)`},settlers:{id:"settlers",title:"Settlers of Kalguur",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
Overview:
...
• Jeweler (gem services)`},sanctum:{id:"sanctum",title:"Sanctum Guide",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
Resolve Management:
...
• Atlas passives and maps`},expedition:{id:"expedition",title:"Expedition Guide",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
Explosive Placement:
...
• Scrap Metal (Tujen currency)`},heist:{id:"heist",title:"Heist Guide",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
Rogue Skills:
...
• Plan escape route
• Prioritize high-value targets`},betrayal:{id:"betrayal",title:"Betrayal Board",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
Transportation:
...
• Betray to create rivalries`},delve:{id:"delve",title:"Delve Guide",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
Sulphite Management:
...
• Kurgal (depth 100+)
• Ahuatotli (depth 35+)
• Unique drops and achievements`},incursion:{id:"incursion",title:"Incursion Temple",category:"cheat-sheets",lastUpdated:new Date().toISOString(),content:`
T3 High Value Rooms:
...
• Consider selling temple access`}};if(e&&t[e]){let i=n.NextResponse.json(t[e]);return i.headers.set("Cache-Control","public, max-age=1800, s-maxage=1800"),i.headers.set("ETag",`"cheat-sheet-${e}-v1"`),i}let i=n.NextResponse.json(Object.values(t));return i.headers.set("Cache-Control","public, max-age=1800, s-maxage=1800"),i.headers.set("ETag",'"cheat-sheets-all-v1"'),i}(s);case"vendor-search":return function(e){let t={"movement-boots":{id:"movement-boots",title:"Movement Speed Boots Search",category:"vendor-search",lastUpdated:new Date().toISOString(),content:`
3 Blue Sockets:
"nt speed".*"b-b-b"
...
2 Green 1 Red:
"nt speed".*"g-g-r|r-g-g|g-r-g"`},"generic-searches":{id:"generic-searches",title:"Generic Search Patterns",category:"vendor-search",lastUpdated:new Date().toISOString(),content:`
...
High Life Items (70+):
"([1-9]\\d{2,}|[7-9]\\d).+life"`}};return e&&t[e]?n.NextResponse.json(t[e]):n.NextResponse.json(Object.values(t))}(s);case"dashboard":return function(e){let t={"info-wiki":{id:"info-wiki",title:"Information & Wiki",category:"dashboard",lastUpdated:new Date().toISOString(),content:`
POE Wiki:
...
Daily labyrinth layouts and guides`},"trading-economy":{id:"trading-economy",title:"Trading & Economy Tools",category:"dashboard",lastUpdated:new Date().toISOString(),content:`
Official Trade Site:
...
In-game overlay for price checking`},"build-planning":{id:"build-planning",title:"Build Planning Tools",category:"dashboard",lastUpdated:new Date().toISOString(),content:`
Path of Building:
...
Build guides and league starter recommendations`},"crafting-planning":{id:"crafting-planning",title:"Crafting & Planning",category:"dashboard",lastUpdated:new Date().toISOString(),content:`
Craft of Exile:
...
POE Regex:
https://poe.re/
Generate search patterns for stash tab highlighting`},"filters-qol":{id:"filters-qol",title:"Filters & QoL",category:"dashboard",lastUpdated:new Date().toISOString(),content:`
FilterBlade:
...
Automatically track mapping progress and income`},"leveling-progression":{id:"leveling-progression",title:"Leveling & Progression",category:"dashboard",lastUpdated:new Date().toISOString(),content:`
POE-Leveling-Guide:
...
POE Atlas:
https://poeatlas.net/
Interactive atlas navigation and progression tracking`}};return e&&t[e]?n.NextResponse.json(t[e]):n.NextResponse.json(Object.values(t))}(s);case"vendor-recipes":return function(e){let t={currency:{id:"currency",title:"Currency Recipes",category:"vendor-recipes",lastUpdated:new Date().toISOString(),content:`
Chromatic Orb:
...
Orb of Augmentation:
3 same base normal items (different names) → 1 Orb of Augmentation`},equipment:{id:"equipment",title:"Equipment Recipes",category:"vendor-recipes",lastUpdated:new Date().toISOString(),content:`
...
Mana Flask Upgrade:
3 Mana Flasks same base type → 1 Mana Flask next tier`},gems:{id:"gems",title:"Gem Recipes",category:"vendor-recipes",lastUpdated:new Date().toISOString(),content:`
Gem Quality Reset:
...
with maximum quality bonus.`},flasks:{id:"flasks",title:"Flask Recipes",category:"vendor-recipes",lastUpdated:new Date().toISOString(),content:`
Iron Flask:
...
combinations as shown above.`}};return e&&t[e]?n.NextResponse.json(t[e]):n.NextResponse.json(Object.values(t))}(s);case"popup":return function(e){let t={"leveling-guide":{id:"leveling-guide",title:"Leveling Quick Ref",category:"popup",lastUpdated:new Date().toISOString(),content:`
        ...
        </div>`},"atlas-quick":{id:"atlas-quick",title:"Atlas Quick Reference",category:"popup",lastUpdated:new Date().toISOString(),content:`
        <div class="text-xs leading-tight space-y-3">
          <div class="border-b border-poe-gold pb-2">
        ...
        </div>`},"movement-boots":{id:"movement-boots",title:"Movement Boots Recipe",category:"popup",lastUpdated:new Date().toISOString(),content:`
        <div class="text-xs leading-tight space-y-3">
          <div class="border-b border-poe-gold pb-2">
        ...
        </div>`},"trading-quick":{id:"trading-quick",title:"Trading Quick Links",category:"popup",lastUpdated:new Date().toISOString(),content:`
        <div class="text-xs leading-tight space-y-3">
          <div class="border-b border-poe-gold pb-2">
        ...
        </div>`},"vendor-recipes":{id:"vendor-recipes",title:"Essential Vendor Recipes",category:"popup",lastUpdated:new Date().toISOString(),content:`
        ...
        </div>`},"heist-table":{id:"heist-table",title:"Heist Quick Reference",category:"popup",lastUpdated:new Date().toISOString(),content:`
        <div class="text-xs leading-tight space-y-3">
          <div class="border-b border-poe-gold pb-2">
        ...
        </div>`},"weapon-bases":{id:"weapon-bases",title:"Weapon Base Types",category:"popup",lastUpdated:new Date().toISOString(),content:`
        <div class="text-xs leading-tight space-y-3">
          <div class="border-b border-poe-gold pb-2">
        ...
        </div>`}};if(e&&t[e]){let i=n.NextResponse.json(t[e]);return i.headers.set("Cache-Control","public, max-age=1800, s-maxage=1800"),i.headers.set("ETag",`"popup-${e}-v1"`),i}let i=n.NextResponse.json(Object.values(t));return i.headers.set("Cache-Control","public, max-age=1800, s-maxage=1800"),i.headers.set("ETag",'"popup-all-v1"'),i}(s);default:return n.NextResponse.json({error:"Invalid module"},{status:400})}}let l=new a.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/popup/route",pathname:"/api/popup",filename:"route",bundlePath:"app/api/popup/route"},resolvedPagePath:"/Users/danielbeach/Code/beachys-poe-helper/app/api/popup/route.ts",nextConfigOutput:"standalone",userland:s}),{workAsyncStorage:c,workUnitAsyncStorage:p,serverHooks:v}=l;function g(){return(0,r.patchFetch)({workAsyncStorage:c,workUnitAsyncStorage:p})}},5303:()=>{}};var t=require("../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),s=t.X(0,[267,814],()=>i(615));module.exports=s})();