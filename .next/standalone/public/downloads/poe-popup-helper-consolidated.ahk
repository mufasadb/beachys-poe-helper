...
F6:: ShowPopup("cheat-sheets", "heist", "Heist Guide")
F7:: ShowPopup("builds", "league-start", "Weapon Bases")
F8:: ShowPopup("cheat-sheets", "settlers", "Settlers Guide")
...
LoadConfig() {
    ...
    Config["popups"] := [
        ...
        {title: "Heist Guide", hotkey: "F6"},
        {title: "Weapon Bases", hotkey: "F7"},
        {title: "Settlers Guide", hotkey: "F8"}
    ]
